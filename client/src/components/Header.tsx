    ...
    <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link href="/login">
            <a className="flex flex-col items-end group">
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px] pt-12" dir="rtl">
              <div className="flex flex-col gap-6">
                 ...
                 <nav className="flex flex-col gap-4">
                    <Link href="/">
                       <a className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg text-gray-700 font-medium" onClick={() => setIsOpen(false)}>
                          الرئيسية
                       </a>
                    </Link>
                    <Link href="/login">
